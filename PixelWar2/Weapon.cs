...
namespace PixelWar2
{
    public abstract class Weapon : Mover
    {
        ...
        private bool Nearby(Point playerLocation, Enemy enemy, Direction direction, int distance) //Yakınlık kontrolü yapıyor. Silahın menzilinde mi değil mi
        {
            bool isNearby = false;
        ...
        protected bool DamageEnemy(Direction direction, int radius, int damage, Random random) // Düşman yakında mı bakıyor sonra enemy.Hit çalışıyor.
        {
        ...
        protected Direction CounterClockWiseDirection(Direction direction) //Saldırı yönlerini tutuyor
        {
